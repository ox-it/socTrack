...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sim.local_id'
        db.add_column('manager_sim', 'local_id', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sim.local_id'
        db.delete_column('manager_sim', 'local_id')
