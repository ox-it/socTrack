...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Log.cause'
        db.add_column('logger_log', 'cause', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manager.SMS'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Log.cause'
        db.delete_column('logger_log', 'cause_id')
